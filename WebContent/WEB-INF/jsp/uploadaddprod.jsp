...
<div id="main_container">
  ...
  <div id="main_content">
   ...
   <form:form action="addProductController.html" method="post" modelAttribute="addprod">        
      <table cellpadding="10px">
						 <div id="error" style="color: red">
     						<%-- ${admin.error} --%>	
     					</div>  					
	  					<tr><td colspan="2" align="center"><font size="3" color="#FF0000"><b>Upload New Products</b></font></td></tr>
            					
     					<tr><td><form:label path="brandname"><font size="3" color="#000000">Brand Name</font></form:label></td>
						<td>
						<form:select  path="brandname">
						    <form:option value="NONE"> --SELECT--</form:option>
						    <form:options items="${addprod.prodList}"></form:options>
						  </form:select>
						...
						<tr><td><form:label path="productname"><font size="3" color="#000000">Product Name</font></form:label></td>
						...
						<tr><td><form:label path="price"><font size="3" color="#000000">Price</font></form:label></td>
						<td><form:input path="price" /></td></tr>
		
						<tr><td><form:label path="product_warranty"><font size="3" color="#000000">Product Warrenty</font></form:label></td>
						<td><form:input path="product_warranty" /></td></tr>
