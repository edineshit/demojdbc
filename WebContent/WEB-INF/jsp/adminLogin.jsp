...
<div id="main_container">
  ...
  <div id="main_content">
   ...
   <form:form action="adminLoginContorller.html" method="post" modelAttribute="admin">        
      <table cellpadding="10px">
						 <div id="error" style="color: red">
     						${admin.error}	
     					</div>  					
	  					<tr><td colspan="2" align="center"><font size="3" color="#FF0000"><b>Administrator Login Here</b></font></td></tr>
            					
     					<tr><td><form:label path="name"><font size="3" color="#000000">Admin Name</font></form:label></td>
