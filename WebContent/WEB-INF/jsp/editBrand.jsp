...
<div id="main_container">
  ...
  <div id="main_content">
   ...
   <form:form action="editBrandController.html" method="post" modelAttribute="command">        
      <table cellpadding="10px">
						 <div id="error" style="color: red">
     						<%-- ${admin.error} --%>	
     					</div>  					
	  					<tr><td colspan="2" align="center"><font size="3" color="#FF0000"><b>Edited Brand Details</b></font></td></tr>
