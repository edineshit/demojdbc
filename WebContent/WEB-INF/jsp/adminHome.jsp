  ...
  <div id="main_content">
    <div id="menu_tab">
      <ul class="menu">
        ...
        <li class="divider"></li>
        <li><a href="addproducts.html" class="nav">Add Brand</a></li>
        <li class="divider"></li>
   ...
   <form:form action="login.html" method="post" modelAttribute="userBean">        
      <table cellpadding="10px">
						 <div id="error" style="color: red">
     						${admin1.name}	
     					</div>  					
	  					<%-- <tr><td colspan="2" align="center"><font size="3" color="#FF0000"><b>User Login Here</b></font></td></tr>
